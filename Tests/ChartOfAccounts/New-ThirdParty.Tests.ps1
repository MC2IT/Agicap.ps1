...
Describe "New-ThirdParty" {
	...
	It "should return a new third-party" {
		$thirdParty = New-AgicapThirdParty "MC2IT-DEVELOPMENT" "MC2IT Development Department" -AccountingAccountNumber 40100000
		Should-BeString 40100000 $thirdParty.AccountingAccountNumber
